...
const AlternatingText: FC<AlternatingTextProps> = ({ slice }) => {
  return (
    ...
    >
      <div>
        <div className="relative grid z-100 justify-center">
          ...
          {slice.primary.textgroup.map((item, index) => (
            ...
            >
              <div
              className={clsx(index % 2 === 0 ? "col-start-1" : "md:col-start-2", "rounded-lg p-4 max-md:backdrop-blur-lg max-md:bg-white/30")}>
                <h2 className="text-balance text-5xl font-bold">
                  <PrismicText field={item.heading} />
                </h2>
                <div className="mt-4 text-lg leading-relaxed opacity-50">
